...
generated by the existing tylertoo generalization engine.
...
object_store). CLI `tylertoo validate <file>` checks spec
...
### E0. `tylertoo export-pmtiles`  (deps: P4, V2 quality gate;
...
### E1. `tylertoo serve`  (deps: P4; reuses shelved mvt.rs/clip.rs)
